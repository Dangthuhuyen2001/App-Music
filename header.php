...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="#"> <img src="img/logo.png" class="rounded-circle" alt="hinh tron" width="40px"
        height="40px" alt="#">
...
<?php
  ...
  {?>
       <!-- Đăng nhập -->
        <li class="nav-item">
          <a class="nav-link" data-toggle="modal" data-target="#exampleModal" href="index.php">Thoát</a>
...
//    print_r($result);
       while ($row = $result->fetch()) {
        ...
        if($Username == $row['admin_name'] && $Password == $row['admin_pass']){
           ...
           setcookie("admin_name", $row['admin_user'] , time() + 3600);
           break;
        }
    }
}
?>   
 <li class="nav-item">
        ...
        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
         ...
         <?php 
              ...
              $sql = 'SELECT * FROM products WHERE product_name LIKE :keyword OR product_desc LIKE :keyword ORDER BY product_id DESC ';
  ...
  $result = $pdo_statement->fetchAll();
        ...
        <form class="form-inline my-2 my-lg-0" action='' method='post'>
          <input class="form-control mr-sm-2" type="text" placeholder="Search" aria-label="Search" name='search[keyword]' value="<?php echo $search_keyword; ?>" id='keyword' maxlength='25'> 
 ...
 color:#08aeea;
  font-size: 30px;
            ...
            <a href="cartt.php" > <i class="fas fa-shopping-cart logo "   ></i></a>
